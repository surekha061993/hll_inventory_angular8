    ...
    })(
        {
            ...
            4: [
                function (t, e, n) {
                    ...
                    function c(t) {
                        ...
                        (e = 2 * s - (n = s < 0.5 ? s * (1 + l) : s + l - s * l)), (a = [0, 0, 0]);
                    ...
                    function x(t) {
                        var e,
                            ...
                            l = t[2];
                        return (
                            o <= 8 ? (a = ((n = (100 * o) / 903.3) / 100) * 7.787 + 16 / 116) : ((n = 100 * Math.pow((o + 16) / 116, 3)), (a = Math.pow(n / 100, 1 / 3))),
            ...
            15: [
                function (t, e, n) {
                    ...
                    var i = t(25),
                        a = t(40),
                        o = t(45);
                    i._set("bar", { hover: { mode: "label" }, scales: { xAxes: [{ type: "category", categoryPercentage: 0.8, barPercentage: 0.9, offset: !0, gridLines: { offsetGridLines: !0 } }], yAxes: [{ type: "linear" }] } }),
                            ...
                            (t.controllers.bar = t.DatasetController.extend({
                                    ...
                                    if (g || (void 0 === g && void 0 !== p))
                                        for (n = 0; n < t; ++n)
                                            (i = u.getDatasetMeta(n)).bar &&
                                                ...
                                                ((a = c.getRightValue(h[n].data[e])), ((f < 0 && a < 0) || (f >= 0 && a > 0)) && (v += a));
                                ...
                                calculateBarIndexPixels: function (t, e, n) {
                                    var i,
                                        ...
                                        m = n.end;
                                    return (
                                        1 === p ? ((i = g > v ? g - v : m - g), (a = g < m ? m - g : g - v)) : (e > 0 && ((i = (g - f[e - 1]) / 2), e === p - 1 && (a = i)), e < p - 1 && ((a = (f[e + 1] - g) / 2), 0 === e && (i = a))),
                            ...
                            t.controllers.bubble = t.DatasetController.extend({
                                ...
                                updateElement: function (t, e, n) {
                                    var i = this,
                                        ...
                                        d = i.index,
                                        c = n ? r.getPixelForDecimal(0.5) : r.getPixelForValue("object" == typeof u ? u : NaN, e, d),
                            ...
                            t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                                ...
                                update: function (t) {
                                    ...
                                    if (f < 2 * Math.PI) {
                                        ...
                                        (u = Math.min(l / C.width, s / C.height)), (d = { x: -0.5 * (S.x + M.x), y: -0.5 * (S.y + M.y) });
                                    }
                                ...
                                updateElement: function (t, e, n) {
                                    ...
                                    o.extend(t, {
                                        ...
                                        _index: e,
                                        _model: { x: u + a.offsetX, y: d + a.offsetY, startAngle: c, endAngle: h, circumference: g, outerRadius: v, innerRadius: p, label: m(f.label, e, a.data.labels[e]) },
                                    });
                                    var b = t._model;
            ...
            18: [
                function (t, e, n) {
                    ...
                    var i = t(25),
                        a = t(40),
                        o = t(45);
                    i._set("line", { showLines: !0, spanGaps: !1, hover: { mode: "label" }, scales: { xAxes: [{ type: "category", id: "x-axis-0" }], yAxes: [{ type: "linear", id: "y-axis-0" }] } }),
                        (e.exports = function (t) {
                            function e(t, e) {
                            ...
                            t.controllers.polarArea = t.DatasetController.extend({
                                ...
                                updateElement: function (t, e, n) {
                                    ...
                                    o.extend(t, {
                                        ...
                                        _index: e,
                                        _scale: u,
                                        _model: { x: h, y: f, innerRadius: 0, outerRadius: n ? k : b, startAngle: n && s.animateRotate ? m : x, endAngle: n && s.animateRotate ? m : y, label: o.valueAtIndexOrDefault(d, e, d[e]) },
                                    }),
            ...
            22: [
                function (t, e, n) {
                    ...
                    var i = t(25),
                        a = t(26),
                        o = t(45);
                    i._set("global", { animation: { duration: 1e3, easing: "easeOutQuart", onProgress: o.noop, onComplete: o.noop } }),
                        (e.exports = function (t) {
                    ...
                    e.exports = function (t) {
                        ...
                        (t.types = {}),
                            ...
                            a.extend(t.prototype, {
                                ...
                                update: function (t) {
                                    var e = this;
                                    if (((t && "object" == typeof t) || (t = { duration: t, lazy: arguments[1] }), n(e), !1 !== s.notify(e, "beforeUpdate"))) {
                                        ...
                                        a.each(
                                            ...
                                            e._bufferedRender ? (e._bufferedRequest = { duration: t.duration, easing: t.easing, lazy: t.lazy }) : e.render(t);
                                    }
                                },
                    ...
                    e.exports = function (t) {
                        ...
                        (o.extend = function (t) {
                                    ...
                                    (i = r[e]),
                                        ...
                                        i.model.skip ||
                                            ...
                                            (o.almostEquals(i.deltaK, 0, this.EPSILON)
                                                ? (i.mK = a.mK = 0)
                                                : ((u = i.mK / i.deltaK), (d = a.mK / i.deltaK), (h = Math.pow(u, 2) + Math.pow(d, 2)) <= 9 || ((c = 3 / Math.sqrt(h)), (i.mK = u * c * i.deltaK), (a.mK = d * c * i.deltaK))));
                                var f;
                                for (e = 0; e < l; ++e)
                                    (i = r[e]).model.skip ||
                                        ((n = e > 0 ? r[e - 1] : null),
                                        (a = e < l - 1 ? r[e + 1] : null),
                                        n && !n.model.skip && ((f = (i.model.x - n.model.x) / 3), (i.model.controlPointPreviousX = i.model.x - f), (i.model.controlPointPreviousY = i.model.y - f * i.mK)),
                                        a && !a.model.skip && ((f = (a.model.x - i.model.x) / 3), (i.model.controlPointNextX = i.model.x + f), (i.model.controlPointNextY = i.model.y + f * i.mK)));
                            }),
                            ...
                            (o.getRelativePosition = function (t, e) {
                                ...
                                return (n = Math.round((((n - l.left - u) / f) * r.width) / e.currentDevicePixelRatio)), (i = Math.round((((i - l.top - d) / g) * r.height) / e.currentDevicePixelRatio)), { x: n, y: i };
                            }),
                    ...
                    e.exports = function (t) {
                        ...
                        t.layoutService = {
                            ...
                            update: function (t, a, o) {
                                ...
                                function l(t) {
                                    t.isHorizontal()
                                        ? ((t.left = t.fullWidth ? d : T), (t.right = t.fullWidth ? a - c : T + S), (t.top = V), (t.bottom = V + t.height), (V = t.bottom))
                                ...
                                if (t) {
                                    ...
                                    i.each(g.concat(p, v, m), function (t) {
                                        var e,
                                            n = t.isHorizontal();
                                        n ? ((e = t.update(t.fullWidth ? x : S, M)), (C -= e.height)) : ((e = t.update(w, k)), (S -= e.width)), _.push({ horizontal: n, minSize: e, box: t });
                                    });
                                    var D = 0,
                                        I = 0,
                                        P = 0,
                                    ...
                                    i.each(g.concat(v), l),
                                        ...
                                        i.each(p, l),
                                        i.each(m, l),
                                        (t.chartArea = { left: T, top: O, right: T + S, bottom: O + C }),
                                        i.each(b, function (e) {
                                    ...
                                    return (
                                        this._plugins.concat(r.plugins || []).forEach(function (t) {
                                            if (-1 === n.indexOf(t)) {
                                                var e = t.id,
                                                    r = l[e];
                                                !1 !== r && (!0 === r && (r = o.clone(i.global.plugins[e])), n.push(t), a.push({ plugin: t, options: r || {} }));
                                            }
                                        }),
                                        (e.descriptors = a),
                                        (e.id = this._cacheId),
            ...
            32: [
                function (t, e, n) {
                    ...
                    o._set("scale", {
                        ...
                        ticks: { beginAtZero: !1, minRotation: 0, maxRotation: 50, mirror: !1, padding: 0, reverse: !1, display: !0, autoSkip: !0, autoSkipPadding: 0, labelOffset: 0, callback: s.formatters.values, minor: {}, major: {} },
                    }),
                        (e.exports = function (t) {
                            function e(t, e, n) {
                            ...
                            t.Scale = r.extend({
                                ...
                                update: function (t, e, n) {
                                    ...
                                    for (
                                        d.beforeUpdate(),
                                            d.maxWidth = t,
                                            d.maxHeight = e,
                                            d.margins = l.extend({ left: 0, right: 0, top: 0, bottom: 0 }, n),
                                ...
                                fit: function () {
                                    ...
                                    if (
                                        ((a.width = f ? (t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth) : h && c.drawTicks ? p : 0), (a.height = f ? (h && c.drawTicks ? p : 0) : t.maxHeight), d.display && h)
                                    ) {
                                    ...
                                    if (u.display && h) {
                                        ...
                                        if (f) {
                                            ...
                                            0 !== t.labelRotation
                                                ? ((t.paddingLeft = "bottom" === r.position ? w * S + 3 : w * x + 3), (t.paddingRight = "bottom" === r.position ? w * x + 3 : w * C + 3))
                                        ...
                                        if (
                                            (l.each(v, function (n, o) {
                                                if (void 0 !== n.label) {
                                                    ...
                                                    if (p) {
                                                        var W = k + B;
                                                        "bottom" === i.position
                                                            ? ((z = g ? "middle" : "top"), (L = g ? "right" : "center"), (R = e.top + W))
                                                            : ((z = g ? "middle" : "bottom"), (L = g ? "left" : "center"), (R = e.bottom - W));
                                            ...
                                            l.each(_, function (t) {
                                                if (
                                                    ...
                                                    var e = t.label;
                                                    if (l.isArray(e)) for (var n = 0, i = 0; n < e.length; ++n) r.fillText("" + e[n], 0, i), (i += 1.5 * b.size);
                                            ...
                                            if (p) (T = e.left + (e.right - e.left) / 2), (F = "bottom" === i.position ? e.bottom - R - S.bottom : e.top + R + S.top);
                                                ...
                                                (T = L ? e.left + R + S.top : e.right - R - S.top), (F = e.top + (e.bottom - e.top) / 2), (O = L ? -0.5 * Math.PI : 0.5 * Math.PI);
                                            }
                    ...
                    e.exports = {
                        generators: {
                            ...
                            logarithmic: function (t, e) {
                                ...
                                0 === l
                                    ? ((n = Math.floor(i.log10(e.minNotZero))), (a = Math.floor(e.minNotZero / Math.pow(10, n))), o.push(l), (l = a * Math.pow(10, n)))
                    ...
                    i._set("global", {
                        ...
                        (e.exports = function (t) {
                            ...
                            function s(t, e) {
                                ...
                                return (
                                    (n.font = o.fontString(d, e._titleFontStyle, e._titleFontFamily)),
                                    o.each(e.title, g),
            ...
            36: [
                function (t, e, n) {
                    ...
                    var i = t(25),
                        a = t(26),
                        o = t(45);
                    i._set("global", { elements: { arc: { backgroundColor: i.global.defaultColor, borderColor: "#fff", borderWidth: 2 } } }),
                        (e.exports = a.extend({
                            ...
                            inRange: function (t, e) {
                                var n = this._view;
                                if (n) {
                                    for (var i = o.getAngleFromPoint(n, { x: t, y: e }), a = i.angle, r = i.distance, l = n.startAngle, s = n.endAngle; s < l; ) s += 2 * Math.PI;
                                    for (; a > s; ) a -= 2 * Math.PI;
                                    for (; a < l; ) a += 2 * Math.PI;
                                    var u = a >= l && a <= s,
            ...
            38: [
                function (t, e, n) {
                    ...
                    a._set("global", { elements: { point: { radius: 3, pointStyle: "circle", backgroundColor: l, borderColor: l, borderWidth: 1, hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1 } } }),
                        (e.exports = o.extend({
                            inRange: function (t, e) {
                                var n = this._view;
            ...
            39: [
                function (t, e, n) {
                    ...
                    var o = t(25),
                        r = t(26);
                    o._set("global", { elements: { rectangle: { backgroundColor: o.global.defaultColor, borderColor: o.global.defaultColor, borderSkipped: "bottom", borderWidth: 0 } } }),
                        (e.exports = r.extend({
                            draw: function () {
                                function t(t) {
                                    return m[(b + t) % 4];
                                ...
                                if (
                                    (u.horizontal
                                        ? ((e = u.base), (n = u.x), (i = u.y - u.height / 2), (a = u.y + u.height / 2), (o = n > e ? 1 : -1), (r = 1), (l = u.borderSkipped || "left"))
                                        : ((e = u.x - u.width / 2), (n = u.x + u.width / 2), (i = u.y), (o = 1), (r = (a = u.base) > i ? 1 : -1), (l = u.borderSkipped || "bottom")),
                                    d)
                                ) {
                ...
                function (t, e, n) {
                    ...
                    var i = {
                        ...
                        each: function (t, e, n, a) {
                            var o, r, l;
                            if (i.isArray(t))
                                if (((r = t.length), a)) for (o = r - 1; o >= 0; o--) e.call(n, t[o], o);
                ...
                function (t, e, n) {
                    ...
                    e.exports = {
                        ...
                        toPadding: function (t) {
                            var e, n, a, o;
                            return i.isObject(t) ? ((e = +t.top || 0), (n = +t.right || 0), (a = +t.bottom || 0), (o = +t.left || 0)) : (e = n = a = o = +t || 0), { top: e, right: n, bottom: a, left: o, height: e + a, width: o + n };
                        },
            ...
            47: [
                function (t, e, n) {
                    ...
                    function a(t, e) {
                        ...
                        if (((t[m] = { initial: { height: a, width: o, style: { display: n.display, height: n.height, width: n.width } } }), (n.display = n.display || "block"), null === o || "" === o)) {
                            var r = i(t, "width");
                            void 0 !== r && (t.width = r);
                        }
                        if (null === a || "" === a)
            ...
            48: [
                function (t, e, n) {
                    ...
                    var i = t(45),
                        ...
                        o = t(47),
                        r = o._enabled ? o : a;
                    e.exports = i.extend({ initialize: function () {}, acquireContext: function () {}, releaseContext: function () {}, addEventListener: function () {}, removeEventListener: function () {} }, r);
                },
                { 45: 45, 46: 46, 47: 47 },
            ],
            49: [
                                ...
                                (t.Legend = a.extend({
                                            ...
                                            if (((l.font = f), v)) {
                                                ...
                                                (l.textAlign = "left"),
                                                    ...
                                                    o.each(t.legendItems, function (n, i) {
                                                        ...
                                                        m[m.length - 1] + o + a.padding >= t.width && ((b += d + a.padding), (m[m.length] = t.left)), (g[i] = { left: 0, top: 0, width: o, height: d }), (m[m.length - 1] += o + a.padding);
                                                    }),
                                                    (p.height += b);
                                            } else {
                                                var x = a.padding,
                                                ...
                                                o.each(t.legendItems, function (t, n) {
                                                    ...
                                                    M + S > p.height && ((k += w + a.padding), y.push(w), (w = 0), (M = 0)), (w = Math.max(w, i)), (M += S), (g[n] = { left: 0, top: 0, width: i, height: d });
                                                }),
                                                    (k += w),
                                                    y.push(w),
                                                    (p.width += k);
                                    ...
                                    draw: function () {
                                        ...
                                        if (n.display) {
                                            ...
                                            (c.textAlign = "left"), (c.textBaseline = "middle"), (c.lineWidth = 0.5), (c.strokeStyle = f), (c.fillStyle = f), (c.font = m);
                                            var b = e(a, g),
                                                x = t.legendHitBoxes,
                                                y = function (t, e, i) {
                                                    if (!(isNaN(b) || b <= 0)) {
                                                ...
                                                w = t.isHorizontal();
                                            d = w ? { x: t.left + (s - u[0]) / 2, y: t.top + a.padding, line: 0 } : { x: t.left + a.padding, y: t.top + a.padding, line: 0 };
                                            var M = g + a.padding;
                                            o.each(t.legendItems, function (e, n) {
                                                var i = c.measureText(e.text).width,
                                                    ...
                                                    l = d.y;
                                                w
                                                    ? r + o >= s && ((l = d.y += M), d.line++, (r = d.x = t.left + (s - u[d.line]) / 2))
                                                    : l + M > t.bottom && ((r = d.x = r + t.columnWidths[d.line] + a.padding), (l = d.y = t.top + a.padding), d.line++),
                                                    y(r, l, e),
                                                    (x[n].left = r),
                                                    (x[n].top = l),
                                                    k(r, l, e, i),
                                        ...
                                        if (a.display) {
                                            ...
                                            (e.fillStyle = n(a.fontColor, r.defaultFontColor)),
                                                ...
                                                t.isHorizontal()
                                                    ...
                                                    : ((s = "left" === a.position ? b + p : y - p), (u = m + (x - m) / 2), (l = x - m), (v = Math.PI * ("left" === a.position ? -0.5 : 0.5))),
                                                e.save(),
                                                e.translate(s, u),
                                                e.rotate(v),
                                                (e.textAlign = "center"),
                                            ...
                                            var k = a.text;
                                            if (o.isArray(k)) for (var w = 0, M = 0; M < k.length; ++M) e.fillText(k[M], 0, w, l), (w += g);
                        ...
                        var e = { position: "left", ticks: { callback: a.formatters.logarithmic } },
                            n = t.Scale.extend({
                                        ...
                                        i.each(r, function (n, a) {
                                            ...
                                            o.isDatasetVisible(a) &&
                                                ...
                                                i.each(n.data, function (t, n) {
                                                    ...
                                                    isNaN(i) ||
                                                        r.data[n].hidden ||
                                                        (null === e.min ? (e.min = i) : i < e.min && (e.min = i),
                                ...
                                getPixelForValue: function (t) {
                                    ...
                                    return (
                                        o.isHorizontal()
                                            ? ((a = i.log10(o.end) - i.log10(r)), 0 === l ? (n = o.left) : ((e = o.width), (n = o.left + (e / a) * (i.log10(l) - i.log10(r)))))
                                            : ((e = o.height),
                                              0 !== r || s.reverse
                                                  ? 0 === o.end && s.reverse
                                                      ? ((a = i.log10(o.start) - i.log10(o.minNotZero)),
                                                        (n = l === o.end ? o.top : l === o.minNotZero ? o.top + 0.02 * e : o.top + 0.02 * e + ((0.98 * e) / a) * (i.log10(l) - i.log10(o.minNotZero))))
                                                      : 0 === l
                                                      ? (n = s.reverse ? o.top : o.bottom)
                                                      : ((a = i.log10(o.end) - i.log10(r)), (e = o.height), (n = o.bottom - (e / a) * (i.log10(l) - i.log10(r))))
                                                  : ((a = i.log10(o.end) - i.log10(o.minNotZero)),
                                                    (n = l === r ? o.bottom : l === o.minNotZero ? o.bottom - 0.02 * e : o.bottom - 0.02 * e - ((0.98 * e) / a) * (i.log10(l) - i.log10(o.minNotZero))))),
                                        n
                                    );
                                },
                                getValueForPixel: function (t) {
            ...
            56: [
                function (t, e, n) {
                    ...
                    e.exports = function (t) {
                        ...
                        function c(t, e, n, i) {
                            if (a.isArray(e)) for (var o = n.y, r = 1.5 * i, l = 0; l < e.length; ++l) t.fillText(e[l], n.x, o), (o += r);
            ...
            57: [
                function (t, e, n) {
                    ...
                    function o(t, e, n, i) {
                        ...
                        for (d.push(n), a = 0, o = d.length; a < o; ++a) (s = d[a + 1]), (r = d[a - 1]), (l = d[a]), (void 0 !== r && void 0 !== s && Math.round((s + r) / 2) === l) || u.push({ time: l, pos: a / (o - 1) });
                        return u;
                    }
                    function r(t, e, n) {
                    ...
                    function f(t, e, n, i, a, o) {
                        ...
                        for (
                            s || (s = d(t, e, n, a)),
                                u && ((f = f.isoWeekday(u)), (g = g.isoWeekday(u))),
                                f = f.startOf(u ? "day" : n),
                                (g = g.startOf(u ? "day" : n)) < e && g.add(1, n),
                                r = v(f),
                                c && i && !u && !l.round && (r.startOf(i), r.add(~~((f - r) / (h.size * s)) * s, n));
                            r < g;
                            r.add(s, n)
                        )
                            p.push(+r);
                    ...
                    function g(t, e, n, i, a) {
                        ...
                        return (
                            a.offset &&
                                e.length &&
                                (a.time.min || ((o = e.length > 1 ? e[1] : i), (r = e[0]), (s = (l(t, "time", o, "pos") - l(t, "time", r, "pos")) / 2)),
                                a.time.max || ((o = e[e.length - 1]), (r = e.length > 1 ? e[e.length - 2] : n), (u = (l(t, "time", o, "pos") - l(t, "time", r, "pos")) / 2))),
                            { left: s, right: u }
                        );
                    }
                    function p(t, e) {
                        var n,
                            ...
                            o,
                            r = [];
                        for (n = 0, i = t.length; n < i; ++n) (a = t[n]), (o = !!e && a === +v(a).startOf(e)), r.push({ value: a, major: o });
                        return r;
                    }
                    var v = t(1);
                                ...
                                determineDataLimits: function () {
                                    ...
                                    for (t = 0, n = (d.data.datasets || []).length; t < n; ++t)
                                        if (d.isDatasetVisible(t))
                                            if (((r = d.data.datasets[t].data), b.isObject(r[0]))) for (p[t] = [], e = 0, o = r.length; e < o; ++e) (l = u(r[e], s)), g.push(l), (p[t][e] = l);
                                            else g.push.apply(g, m), (p[t] = m.slice(0));
                                        else p[t] = [];
                                    m.length && ((m = a(m).sort(i)), (h = Math.min(h, m[0])), (f = Math.max(f, m[m.length - 1]))),
                                        g.length && ((g = a(g).sort(i)), (h = Math.min(h, g[0])), (f = Math.max(f, g[g.length - 1]))),
                                        (h = h === y ? +v().startOf("day") : h),
